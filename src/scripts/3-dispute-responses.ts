...
/**
 * Dispute Responses script
 *
 * The goal of this script is to raise disputes for the last response.
 *
 * Requirements:
 *  1. Run the Create Requests and the Propose Responses scripts
 *  2. Fund the disputer wallet with ETH, WETH, USDT and USDC
 */
...
(async () => {
  ...
  const sdk = new ProphetSDK(runner, address.deployed[getNetworkName()].ORACLE);
